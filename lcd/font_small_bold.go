...
func (d *LCD) load_font_small_bold_rune(char rune) (image.Image, error) {
...
func (d *LCD) Use_Font_Small_Bold() map[rune]image.Image {
...
func (d *LCD) Load_Font_Small_Bold() {
	const fontPrefix = "smallbold"
	mapping := Font_small_bold_rune_map
	mapfunc := d.load_font_small_bold_rune
